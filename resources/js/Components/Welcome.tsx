...
export default function Welcome() {
    return (
        <div>
            ...
            <div className='grid grid-cols-1 bg-gray-200 bg-opacity-25 md:grid-cols-2'>
                <div className='p-6'>
                    <div className='flex items-center'>
                        ...
                        <div className='ml-4 text-lg font-semibold leading-7 text-gray-600'>
                ...
                <div className='border-t border-gray-200 p-6 md:border-l'>
                    <div className='flex items-center'>
                        ...
                        <div className='ml-4 text-lg font-semibold leading-7 text-gray-600'>Authentication</div>
                    </div>
