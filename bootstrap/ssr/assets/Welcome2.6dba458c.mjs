...
import { u as useRoute, a as jsxs, j as jsx, F as Fragment } from "../ssr.mjs";
...
function Welcome({
  ...
  return /* @__PURE__ */ jsxs("div", {
    className: "items-top relative flex min-h-screen justify-center bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0",
    children: [/* @__PURE__ */ jsx(Head, {
      title: "Welcome"
    }), canLogin ? /* @__PURE__ */ jsx("div", {
      className: "fixed top-0 right-0 hidden px-6 py-4 sm:block",
      children: page.props.user ? /* @__PURE__ */ jsx(Link, {
      ...
      className: "mx-auto max-w-6xl sm:px-6 lg:px-8",
      children: [/* @__PURE__ */ jsx("div", {
        ...
        className: "mt-8 overflow-hidden bg-white shadow dark:bg-gray-800 sm:rounded-lg",
          ...
          children: [/* @__PURE__ */ jsxs("div", {
            ...
            children: [/* @__PURE__ */ jsxs("div", {
              ...
              children: [/* @__PURE__ */ jsx("svg", {
                ...
                className: "ml-4 text-lg font-semibold leading-7",
            ...
            className: "border-t border-gray-200 p-6 dark:border-gray-700 md:border-t-0 md:border-l",
            children: [/* @__PURE__ */ jsxs("div", {
              className: "flex items-center",
            ...
            className: "border-t border-gray-200 p-6 dark:border-gray-700 md:border-l",
            children: [/* @__PURE__ */ jsxs("div", {
              className: "flex items-center",
              children: [/* @__PURE__ */ jsx("svg", {
                fill: "none",
                ...
                className: "ml-4 text-lg font-semibold leading-7 text-gray-900 dark:text-white",
              ...
              children: /* @__PURE__ */ jsxs("div", {
                className: "mt-2 text-sm text-gray-600 dark:text-gray-400",
                children: ["Laravel's robust library of first-party tools and libraries, such as", " ", /* @__PURE__ */ jsx("a", {
                  ...
                  className: "underline",
                  children: "Envoyer"
                }), " ", "help you take your projects to the next level. Pair them with powerful open source libraries like", " ", /* @__PURE__ */ jsx("a", {
        ...
        className: "mt-4 flex justify-center sm:items-center sm:justify-between",
        children: [/* @__PURE__ */ jsx("div", {
          ...
          className: "ml-4 text-center text-sm text-gray-500 sm:ml-0 sm:text-right",
